defmodule TetrisScenic.Scene.Game do
  use Scenic.Scene
  alias Scenic.Graph
  ...
  @frame_ms 192
  @pellet_score 100
  @game_over_scene TetrisScenic.Scenes.GameOver
  ...
  defp draw_game_objects(graph, object_map) do
    Enum.reduce(
      object_map,
      graph,
      fn {object_type, object_data}, graph ->
  ...
  defp maybe_eat_pellet(
         state = %{
           objects: %{
             pellet: pellet_coords
           }
         },
         snake_head_coords
       )
